...
- `npx_gate_phase1_validation_plan.md`: Phase 1 세부 검증 계획
- `vision_frontend_validation_roadmap.md`: 전체 장기 로드맵

## 10. 다음 작업

바로 다음 구현 작업은 Task 1이다.

```text
1. 디렉터리 스캐폴딩 생성
2. 기본 config 파일 작성
3. 공통 frame/ROI/detection schema 정의
4. video loader skeleton 구현
5. ROI gate emulator skeleton 구현
```
